...
zfile_name = "data/1_PrilmaryLocation_30_ 210622_1009849_RNE_PRIMLOCK-SUB_IN_79591225.zip"
file_name = "1_PrilmaryLocation_30_ 210622_1009849_RNE_PRIMLOCK-SUB_IN_79591225.txt"
...
print(xml_str)
with open('data/result-slc.xml', 'w') as file:
    file.write(xml_str)
